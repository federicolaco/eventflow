...
router.post("/", async (req, res) => {
  try {
    ...
    const validadorInventario = new ValidadorDeInventario(req.redisClient, process.env.EVENTS_SERVICE_URL)
    const calculadorPrecio = new CalculadorDePrecio(process.env.EVENTS_SERVICE_URL)
    ...
    const saga = new SagaOrchestrator(processedRequest.reservation, req.redisClient)
